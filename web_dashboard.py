...
<div class="d-flex justify-content-between"><h1><i class="fas fa-shield-halved text-primary"></i> Shadow Legion <small class="text-secondary">v56.0-Cloud</small></h1><div><span id="liveTime"></span> <i class="fas fa-sync-alt refresh-btn text-info" onclick="fetchAll()"></i> <a href="/logout" class="btn btn-sm btn-outline-danger">خروج</a></div></div>
