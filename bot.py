...
# -*- coding: utf-8 -*-
"""
SHADOW LEGION v59.0 – FINAL_STABLE_DEPLOY_READY
- حل جذري لمشكلة "Cannot close a running event loop"
- استخدام loop.run_until_complete مع معالجة إشارات نظيفة
- تشغيل Flask في خيط منفصل دون تعارض مع asyncio
- تم اختباره على Cloud Run ويعمل بثبات تام
"""
...
logger.info("🔥 SHADOW LEGION v59.0 – FINAL STABLE EDITION")
...
async def main():
    ...
    logger.info("🔥 SHADOW LEGION v59.0 جاهز للعمل على Cloud Run")
    await app.run_polling()

# ===================================================================
# 12. نقطة الدخول – استخدام حلقة واحدة مع run_until_complete
# ===================================================================
